    ...
    <div className="fixed inset-0 z-10 flex items-center pointer-events-none" style={{ opacity }}>
      <div className={`pointer-events-auto ${
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 2 }}>
          {/* Accent line */}
          <motion.div
            className={`mb-4 md:mb-6 h-px bg-gradient-to-l from-[#6C7CFF] to-transparent ${
          ...
          {/* Bottom line */}
          <motion.div
            className={`mt-4 md:mt-6 h-px bg-gradient-to-l from-[#6C7CFF]/30 to-transparent ${
              isMobile ? 'mx-auto' : 'ml-auto'
            }`}
            initial={{ width: 0 }}
          ...
          >
            <span className="font-mono text-[8px] tracking-[0.4em] uppercase mb-2" style={{ color: '#505560' }}>
              {isMobile ? 'Swipe up' : 'Scroll'}
            </span>
            <motion.div
              className="w-px h-6 md:h-8 bg-gradient-to-b from-[#6C7CFF]/30 to-transparent"
              animate={{ y: [0, 6, 0] }}
